...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    for device_id, device_data in coordinator.data.items():
        ...
        if CAP_WASHING_COURSE in status:
            selects.append(GenericCourseSelect(coordinator, device_id, name, CAP_WASHING_COURSE, "washingCourse", "setDishwasherWashingCourse", "Dishwasher Course"))
            
        if CAP_WASHER_COURSE in status:
            selects.append(GenericCourseSelect(coordinator, device_id, name, CAP_WASHER_COURSE, "washerCycle", "setWasherCycle", "Washer Course"))
            
        if CAP_DRYER_COURSE in status:
            selects.append(GenericCourseSelect(coordinator, device_id, name, CAP_DRYER_COURSE, "dryerCycle", "setDryerCycle", "Dryer Course"))
...
class GenericCourseSelect(CoordinatorEntity, SelectEntity):
    ...
    def __init__(self, coordinator, device_id, device_name, capability, attribute, command, name):
        ...
        self._attr_unique_id = f"{device_id}_{capability}"
    ...
    async def async_select_option(self, option: str) -> None:
        ...
        await self.coordinator.api.execute_command(self._device_id, self._capability, self._command, [option])
